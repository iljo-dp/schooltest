...
static const char *dmenucmd[] = { "dmenu_run",  "-fn", dmenufont, "-sb", col_cyan, "-sf", col_gray4,  NULL };
...
static const char *dobright[] = {"brightnessctl", "set", "5%-", NULL};
#include "shiftview.c"
